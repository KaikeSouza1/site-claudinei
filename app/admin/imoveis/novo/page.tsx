...
export default function NovoImovel() {
  ...
  const handleImportar = async () => {
    ...
    try {
      ...
      if (res.ok) {
        setFormData({ ...formData, ...data, preco: data.preco ? data.preco.toString() : '' });
  ...
  return (
    <div className="max-w-6xl mx-auto pb-20">
      ...
      <div className="bg-[#1a304d]/40 border border-gold/20 rounded-xl p-6 mb-8">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <input type="url" placeholder="https://..." value={linkImportacao} onChange={(e) => setLinkImportacao(e.target.value)} className="flex-1 bg-[#020b18] border border-slate-700 text-white px-4 py-3 rounded-lg focus:outline-none focus:border-gold text-sm" />
